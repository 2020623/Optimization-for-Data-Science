...
We recommend to open the notebook with Colab if is possible, in order to have a
better visualization.
Moreover, the weights used in the notebook come from  https://github.com/IBM/ZOSVRG-BlackBox-Adv/tree/master/models.
